...
public class Questions extends AbstractController {
	...
	public static void view(Long questionId) {
		Question question = Question.findById(questionId);
		render(question);
	}

	public static void storeQuestion(
			@Required(message = "Title is required") String questionTitle,
			...
			@Required(message = "Content is required") String questionContent,
			String explanation,
			@Required(message = "Response type is required") String questionType,
			String correct, String response1, String response2,
		...
		if (validation.hasErrors()) {
			render("Questions/create.html", questionTitle, difficulty, second,
					groupType, questionContent, explanation);
		}

		Question question = new Question(questionTitle, questionContent,
				explanation, difficulty, second,
				(GroupType) GroupType.findById(groupType),
	...
	public static void search(String questionTitle, Integer difficulty,
			Integer second, Long groupType) {
